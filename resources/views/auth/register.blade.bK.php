    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="row">
            ...
            <label for="fname" class="text-white">First Name</label>
                <input id="fname" name="first_name"  value="{{ old('first_name') }}" type="text" class="form-control autocar-input" placeholder="First name">
                @error('first_name')
            ...
            <div class="col-md-6">
                ...
                <input id="lname" name="last_name" value="{{ old('last_name') }}" type="text" class="form-control autocar-input" placeholder="Last name">
                @error('last_name')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <input id="email" name="email" type="text" class="form-control autocar-input" placeholder="Email"  value="{{ old('email') }}">
                @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <input id="password" name="password" type="password" class="form-control autocar-input" placeholder="Password">
                @error('password')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
