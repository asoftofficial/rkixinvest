            ...
            <div class="modal-body pt-0">
                <form action="{{route('admin.userprofile.store')}}" enctype="multipart/form-data"   method="post">
                    ...
                    <div class="form-group plan-name">
                        ...
                        <input type="text" class="form-control bg-light border-0 round-10" name="fname" required="" value="{{old('fname')}}" id="fname">
                        @error('fname')
                    ...
                    <div class="form-group plan-name1">
                        ...
                        <textarea rows="4" class="form-control bg-light border-0 round-10" name="lname" value="{{old('lname')}}" required="" id="lname"></textarea>
                        @error('lname')
                        <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control bg-light border-0 round-10" name="email" required="" value="{{old('email')}}" id="email">
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
