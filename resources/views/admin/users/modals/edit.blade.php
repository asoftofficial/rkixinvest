                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="gap">
                                        <h4 class="input-label mt-2">First name</h4>
                                        <div class="">
                                            <input type="text" class="form-control bg-light round-10 border-0" name="fname" value="{{$item->first_name}}" >
                                        </div>
                                        @error('fname')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-6">
                                    <div class="gap">
                                        ...
                                        <div class="">
                                            <input type="text" class="form-control bg-light round-10 border-0" name="lname" value="{{$item->last_name}}">
                                        </div>
                                        @error('lname')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="gap">
                                        <h4 class="input-label mt-2">Email</h4>
                                        <div class="">
                                            <input type="email" class="form-control bg-light round-10 border-0 mb-4" name="email" value="{{$item->email}}">
                                        </div>
                                        @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-6">
                                    <div class="gap">
                                        ...
                                        <select name="role" required="" class="form-control bg-light round-10 border-0 mb-4">
                                            <option value="admin" class="sel-v">admin</option>
                                            <option value="user" class="sel-v">user</option>
