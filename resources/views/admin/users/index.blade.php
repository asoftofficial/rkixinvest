    ...
    <div class="container-fluid">
        ...
        <section class="admin-search-area">
            <div class="admin-search-left">
                <button class="btn btn-info px-5 btn-dark round-10" data-toggle="modal" data-target="#addUserModal">Add a user</button>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="min-width: 256px">
                                ...
                                @if($item->blocked == 0)
                                <a href="#" class="btn btn-danger blocked_user " data-id="{{$item->id}}" ><p class="text-white block_button" style="font-size: 17px;height:0.8vh; ">Blocked</p></a>
                                 @else
                                 <a href="#" class="btn btn-success blocked_user " data-id="{{$item->id}}" ><p class="text-white block_button" style="font-size: 17px;height:1vh;">Unblock</p></a>
                            @endif

                            <a href="#" class="user_email  btn btn-dark" data-toggle="modal" data-target="#userEmailModal-{{$item->id}}" ><i class="fas fa-envelope text-white" size="3"></i></a>
                            <a href="#" class="delete btn btn-dark" data-id="{{$item->id}}" ><i class='fas fa-trash-alt text-white' style='font-size:20px;'></i></a>
...
@push('script')
    ...
    <script>
        ...
        $(".blocked_user").click(function(e){
             swal({
                  title: "Are you sure ?",
                  text: "you want to apply this opreation",
                  icon: "warning",
                  buttons: true,
                  dangerMode: true,
                })
