<div class="modal fade" id="editPromotionModal-{{$promotion->id}}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-610" role="document">
        <div class="modal-content issue-padd">
            <div class="modal-header pb-0">
                <h5 class="modal-title" id="exampleModalLabel mt-0">Edit Promotion</h5>
            </div>
            <form action="{{route('admin.promotions.update',$promotion)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body  pt-0">
                    <div class="form-group">
                        ...
                        <input name="name" type="text" class="form-control bg-light border-0 round-10 " value="{{old('name', $promotion->name)}}" />
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="desc" rows="6" class="form-control bg-light border-0 round-10 " id="Promotion text">{{old('desc', $promotion->desc)}}</textarea>
                        @error('desc')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                                        ...
                                        <div class="drop-icon">
                                            <select name="plan" class="form-control bg-light round-10 border-0" required>
                                                ...
                                                @foreach($plans as $plan)
                                                    <option value="{{$plan->id}}" class="sel-v" @if(old('plan', $promotion->plan_id)==$plan->id) selected @endif>{{$plan->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        @error('plan')
                                    ...
                                    <div class="gap">
                                        ...
                                        <div class="drop-icon">
                                            <select name="type" class="form-control bg-light round-10 border-0">
                                                ...
                                                <option value="per" class="sel-v" @if(old('type', $promotion->discount_type)=="per") selected @endif>Percentage</option>
                                                <option value="flat" class="sel-v" @if(old('type', $promotion->discount_type)=="flat") selected @endif>Flat</option>
                                            </select>
                                        </div>
                                        @error('type')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-6">
                                    <div class="gap1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="discount" class="form-control bg-light border-0 round-10" value="{{old('discount', $promotion->discount)}}" />
                                            @error('discount')
                                            <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="gap">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control bg-light border-0 round-10" name="code" value="{{old('code', $promotion->code)}}" />
                                            @error('code')
                                            <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="col-md-6">
                                    <div class="gap1">
                                        ...
                                        <div class="drop-icon">
                                            <select name="number_of_codes" class="form-control bg-light round-10 border-0" disabled>
                                ...
                                <div class="col-md-6">
                                    <div class="gap">
                                        <div class="form-group">
                                            ...
                                            <div class="drop-icon">
                                                <input type="text" class="form-control bg-light border-0 round-10 datepicker" autocomplete="off" required="" name="start_date" value="{{old('start_date', $promotion->start_date)}}">
                                            </div>
                                            @error('start_date')
                                            <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="gap1">
                                            ...
                                            <div class="drop-icon">
                                                <input type="text" class="form-control bg-light border-0 round-10 datepicker" autocomplete="off" required="" name="end_date" value="{{old('end_date', $promotion->end_date)}}">
                                                @error('end_date')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="col-md-6">
                                    <div class="gap">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="limt_per_user" class="form-control bg-light border-0 round-10" value="{{old('limt_per_user', $promotion->limt_per_user)}}"/>
                                            @error('limt_per_user')
                                            <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="col-md-6">
                                    <div class="gap1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="limit_per_coupon" class="form-control bg-light border-0 round-10" value="{{old('limit_per_coupon', $promotion->limit_per_coupon)}}" />
