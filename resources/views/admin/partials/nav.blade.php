...
{{--                    <!-- Message Start -->--}}
{{--                    <div class="media">--}}
{{--                        <img src="/frontend/dashboard/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">--}}
...
{{--                    <!-- Message Start -->--}}
{{--                    <div class="media">--}}
{{--                        <img src="/frontend/dashboard/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">--}}
{{--                        <div class="media-body">--}}
{{--                            <h3 class="dropdown-item-title">--}}
{{--                                John Pierce--}}
...
{{--                    <!-- Message Start -->--}}
{{--                    <div class="media">--}}
{{--                        <img src="/frontend/dashboard/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">--}}
{{--                        <div class="media-body">--}}
{{--                            <h3 class="dropdown-item-title">--}}
{{--                                Nora Silvester--}}
