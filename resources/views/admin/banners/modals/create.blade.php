<div class="modal fade" id="addBannersModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-610" role="document">
        <div class="modal-content banner-modal">
            <div class="modal-header pb-0">
                <h5 class="modal-title" id="exampleModalLabel">Create a new banner</h5>
            </div>
            <div class="modal-body  pt-0">
                <form action="{{route('admin.banners.store')}}" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group plan-name">
                        ...
                        <input type="text" name="name" class="form-control bg-light border-0 round-10" required="" value="{{old('name')}}">
                        @error('name')
                                    ...
                                    <div class="gap">
                                        ...
                                        <div class="drop-icon">
                                            <select name="type" class="form-control bg-light round-10 border-0" required="">
                                                ...
                                                <option value="Skyscraper" class="sel-v">Skyscraper</option>
                                                <option value="Standard" class="sel-v">Standard</option>
                                                <option value="Mobile" class="sel-v">Mobile</option>
...
{{--                                                <option value=""></option>--}}
{{--                                                <option value="2">Main Header</option>--}}
