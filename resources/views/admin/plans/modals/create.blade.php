            ...
            <div class="modal-body pt-0">
                <form action="{{route('admin.plans.store')}}" enctype="multipart/form-data"   method="post">
                    ...
                    <div class="form-group plan-name">
                        ...
                        <input type="text" class="form-control bg-light border-0 round-10" name="name" required="" value="{{old('name')}}">
                        @error('name')
                    ...
                    <div class="form-group plan-name1">
                        ...
                        <textarea rows="4" class="form-control bg-light border-0 round-10" name="description" value="{{old('description')}}" required="" id="description"></textarea>
                        @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                   <h4 class="input-label mt-1">Monthly Price</h4>
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control bg-light border-0 round-10" name="price" required="" value="{{old('price')}}"  aria-label="Username" aria-describedby="basic-addon1">
                                        @error('price')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6 available-radio">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" value="1" name="front" id="inlineRadio1" checked="" value="option1">
                                        <label class="form-check-label pound" for="inlineRadio1">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" value="0" name="front" id="inlineRadio2" value="option2">
...
{{--                                    <label class="form-check-label pound" for="inlineRadio1">Autocar</label>--}}
{{--                                </div>--}}
{{--                                <div class="form-check form-check-inline">--}}
{{--                                    <input class="form-check-input" type="checkbox" name="inlineRadioOptions" id="inlineRadio2" value="option2">--}}
{{--                                    <label class="form-check-label pound" for="inlineRadio2">Classic and Sports Car</label>--}}
{{--                                </div>--}}
{{--                                <div class="form-check form-check-inline">--}}
{{--                                    <input class="form-check-input" type="checkbox" name="inlineRadioOptions" id="inlineRadio2" value="option2">--}}
{{--                                    <label class="form-check-label pound" for="inlineRadio2">What a Car</label>--}}
{{--                                </div>--}}
                            </div>
                      </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control bg-light border-0 round-10" name="stripe_id" required="" value="{{old('stripe_id')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="partner_name" value="{{old('partner_name')}}" class="form-control bg-light border-0 round-10">
                                        @error('partner_name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea rows="4" name="text" class="form-control bg-light border-0 round-10" id="description">{{old('text')}}</textarea>
                                @error('text')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
