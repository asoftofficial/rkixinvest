...
@section('content')
    <div class="container-fluid">
                <div class="dashboard-first-line d-flex justify-content-between flex-wrap">
                    <div class="dashboard-card upload-issues d-flex align-items-center justify-content-center">
                        <a href="#" class="dashboard-card-link" data-toggle="modal" data-target="#addIssuesModal">
                            UPLOAD ISSUES
                        </a>
                    </div>
                    <div class="dashboard-card page-views">
                        <a href="#" class=" dashboard-card-dropdown"><i class="fas fa-ellipsis-h"></i></a>
                    ...
                    <div class="dashboard-card total-earnings bg-dark">
                        <a href="#" class="text-white dashboard-card-dropdown"><i class="fas fa-ellipsis-h"></i></a>
                        <div class="dashboard-card-header">
                ...
                <div class="dashboard-second-line d-flex justify-content-between flex-wrap">
                    <div class="cards-section d-flex flex-column align-content-between">
                        <div class="dashboard-card upload-banner d-flex align-items-center justify-content-center">
                            <a href="#" class="dashboard-card-link" data-toggle="modal" data-target="#addBannersModal">
                                UPLOAD BANNERS
                            </a>
                        </div>
                        <div class="dashboard-card add-promotions d-flex align-items-center justify-content-center">
                            <a href="#" class="dashboard-card-link" data-toggle="modal" data-target="#addPromotionsModal">
                                ADD PROMOTION
                            </a>
                        </div>
                    </div>
