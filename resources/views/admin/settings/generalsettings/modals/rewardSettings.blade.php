...
<div class="modal fade" id="generalsettings" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="false">
                            ...
                            <div class="row">
                                    ...
                                    <div class="gap">
                                        <div class="main mt-3 justify-content-start">
                                            <div class="referal-button">
                                                ...
                                                <h4 class="input-label mt-2" id="refrel_level">Referal_system level</h4>
                                ...
                                <div class="col-md-6">
                                    <div class="gap1">
                                        ...
                                        <input type="text" name="refrelsystem_level" value="{{old('refrelsystem_level')}}" class="form-control bg-light border-0 round-10 ">
 ...
 {{-- Email setting --}}
 <hr>
 <h5 class="modal-title" id="exampleModalLabel mt-0">Email settings</h5>
 <div class="row mb-5">
     <div class="col-md-12">
         <div class="row">
             <div class="col-md-6 justify-content-start">
                 <div class="gap">
                     <div class="main mt-3">
                         <div class="confirmation-button">
                             ...
                             <h4 class="input-label mt-2" id="confirmation-heading">Confirmation email</h4>
                             <div class="confirmation_email-toggle">
