<div class="modal fade" id="addMagazineModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog   modal-610" role="document">
        <div class="modal-content ">
            <div class="modal-header pb-0">
                <h5 class="modal-title" id="exampleModalLabel">Add a Magazine</h5>
            </div>
            <div class="modal-body pt-0">
                <form action="{{route('admin.magazines.store')}}" enctype="multipart/form-data"   method="post">
                    ...
                    <div class="form-group plan-name">
                        ...
                        <input type="text" class="form-control bg-light border-0 round-10" name="title" required="" value="{{old('title')}}">
                        @error('title')
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control bg-light border-0 round-10 datepicker" autocomplete="off" name="first_published" required="" value="{{old('first_published')}}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="country_id" id="country" class="form-control bg-light border-0 round-10">
                                        ...
                                        @foreach($countries as $count)
                                            <option value="{{ $count->id }}" {{old('country_id')==$count->id?'selected':''}} >{{ $count->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('country')
                                    <span class="invalid-feedback" role="alert">
