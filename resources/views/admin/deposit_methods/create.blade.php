...
@section('header-right')
    <a href="{{ route('admin.deposit-gateways.index') }}" class="btn btn-primary btn-blue header-right-btn">Back</a>
@endsection
@push('style')
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card main-card">
                    <form action="{{ route('admin.deposit-gateways.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                                ...
                                <div class="payment-method-header">
                                    <div class="thumb">
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <label for="image" class="blue-bg text-white"><i class="fas fa-pencil-alt"></i></label>
                                        </div>
                                    </div>
                                    <div class="content">
                                        ...
                                        <div class="col-lg-12 mt-3">
                                            <div class="card border--dark">
                                                <h5 class="card-header bg--dark">@lang('User data')
                                                    <button type="button" class="btn btn-sm btn-outline-blue float-right addUserData">
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary btn-blue btn-block">@lang('Save Method')</button>
                        </div>
                    </form>
                </div><!-- card end -->
            </div>
