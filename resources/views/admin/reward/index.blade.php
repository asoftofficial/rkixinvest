...
<div class="container-fluid">
    ...
    <section class="admin-search-area">
        <div class="admin-search-left">
            <button class="btn btn-info px-3 blue-bg round-10" data-toggle="modal" data-target="#addRewardModal">Create reward</button>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="min-width: 256px; text-align: right">
                            ...
                            <a href="#" class="btn btn-info blue-bg round-10 px-5 mr-2" data-target="#editRewardModal-{{$item->id}}" data-toggle="modal">Edit</a>
                            <a href="#" class="delete btn btn-dark" data-id="{{$item->id}}"><i class='fas fa-trash-alt' style='font-size:20px;color:white;'></i></a>
                        </td>
                    </tr>
