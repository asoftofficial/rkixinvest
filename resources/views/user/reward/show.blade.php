...
@push('style') < style >.content - wrapper {
    ...
    #zoom_controls button {
        border: none;
        background: #fff;
        box - shadow: 1 px 1 px 5 px rgb(0 0 0 / 20 %);
        padding: 5 px 15 px;
        font - size: 18 px;
        border - radius: 50 %;
        font - weight: bold;
    ...
    <section class="issue">
        <div id="my_pdf_viewer" class="pdf_viewer">
            <div id="canvas_container" class="pdf_container">
                <a href="#" class="back-link">Back</a > <canvas id="pdf_renderer"></canvas>
...
<div id="navigation_controls">
    <button id="go_previous">
        << /button> <input id="current_page" value="1" type="number" /> / <span
        id="totalPages"></span> <button id="go_next" class="go_next">></button>
</div>
</div>
