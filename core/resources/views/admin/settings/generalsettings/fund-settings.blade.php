                ...
                <form action="{{route('admin.post.fund.settings')}}" method="post">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="checkbox" id="addfund" name="addfund" @if($settings->add_fund == 'on') checked
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="checkbox" id="removefund" name="removefund"
                                   @if($settings->remove_fund == 'on') checked @endif data-toggle="toggle">
                            @error('removefund')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                ...
                <form action="{{route('admin.fund.transfer')}}" method="post">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="checkbox" class="switch" name="fund_transfer"
                                   @if($settings->fund_transfer == 'on') checked @endif data-toggle="toggle">
                            @error('fund_transfer')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="charges" class="form-control bg-light border-0 round-10"
                                   value="{{old('charges',$settings->transfer_charges)}}">
                            @error('charges')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="min_transfer" class="form-control bg-light border-0 round-10"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="max_transfer" class="form-control bg-light border-0 round-10"
