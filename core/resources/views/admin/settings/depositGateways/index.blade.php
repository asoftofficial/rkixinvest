                            ...
                            <td>
                                <div class="fund-button">
                                    ...
                                    <div class="fund-toggle">
                                        <input type="checkbox" id="removefund-{{ $pg->id }}" name="removefund"
                                               @if($pg->status == 1) checked @endif>
                                        <label for="removefund-{{ $pg->id }}"></label>
                                    </div>
                                </div>
                            </td>
                            <td style="min-width: 256px; text-align: right">
                                <a href="#" class="btn btn-info blue-bg round-10 px-5 mr-2" data-target="#editGateWayModal-{{$pg->id}}" data-toggle="modal">Edit</a>
                            </td>
                        </tr>
