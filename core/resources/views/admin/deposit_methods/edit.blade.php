...
@section('header-right')
    <a href="{{ route('admin.withdraw.gateways') }}" class="btn btn-primary btn-blue header-right-btn">Back</a>
@endsection
@push('style')
...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <form action="{{ route('admin.deposit-gateways.update', $method) }}" method="POST"
                                ...
                                <div class="payment-method-header">
                                    <div class="thumb">
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <label for="image" class="bg-blue"><i class="fas fa-pencil-alt"></i></label>
                                        </div>
                                    </div>
                                    <div class="content">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="card border--primary mb-2">
                                                <h5 class="card-header bg-blue">@lang('Range')</h5>
                                                <div class="card-body">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="card border--primary">
                                                <h5 class="card-header bg-blue">@lang('Charge')</h5>
                                                <div class="card-body">
                                                    <div class="input-group has_append mb-3">
                                                ...
                                                <div class="card-body">
                                                    <div class="row addedField">
                                                        ...
                                                        @if($method->user_data != null)
                                                            @foreach(json_decode($method->user_data) as $k => $v)
                                                                <div class="col-md-12 user-data">
                                                                    <div class="form-group">
                                                                        <div class="input-group mb-md-0 mb-4">
                                                                            <div class="col-md-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        @if($method->parameters != null)
                                                            @foreach(json_decode($method->parameters) as $k => $v)
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="w-100">{{strtoupper(str_replace('_',' ',$k))}}<span class="text-danger">*</span></label>
                                                                    <input type="text" class="form-control" placeholder="0" name="{{ $k }}" value="{{ $v }}"/>
                                                                </div>
                                                            </div>
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn text-white btn-blue btn-block">@lang('Save Method')</button>
                        </div>
                    </form>
                </div><!-- card end -->
            </div>
