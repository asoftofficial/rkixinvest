<div class="modal fade" id="userEmailModal-{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog   modal-610" role="document">
        <div class="modal-content ">
            ...
            <div class="modal-body pt-0">
                <form action="{{route('admin.user.email',$user->id)}}" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="form-group plan-name">
                        <label for="subject" class="input-label">Subject:</label>
                        <input type="text" class="form-control bg-light border-0 round-10" name="subject" required="required" id="subject">
                            @error('Subject')
