...
@section('header-right')
    <a href="{{route('admin.deposit.log')}}" class="btn btn-primary btn-blue header-right-btn">All Logs</a>
@endsection
@push('style')
...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            @if(request()->routeIs('admin.deposit.log') || request()->routeIs('admin.withdraw.method') || request()->routeIs('admin.users.deposits') || request()->routeIs('admin.users.deposits.method'))
                <div class="col-xl-4 col-sm-6 mb-3">
                    <div class="widget-two b-radius-5 bg-success">
                        <div class="widget-two__content">
                            <h2 class="text-white">USD {{ $$deposit-->where('status',1)->sum('amount') }}</h2>
                                ...
                                @forelse($deposits as $deposit)
                                    ...
                                    <tr>
                                        <td data-label="@lang('Gateway | Trx')">
                                            <span class="font-weight-bold"><a href="{{ route('admin.withdraw.method',[$deposit->method->id,'all']) }}"> {{ __(@$deposit->method->name) }}</a></span>
                                            <br>
