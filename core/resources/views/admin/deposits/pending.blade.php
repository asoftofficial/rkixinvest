...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            @if(request()->routeIs('admin.deposit.log') || request()->routeIs('admin.deposit.method') || request()->routeIs('admin.users.deposits') || request()->routeIs('admin.users.deposits.method'))
                ...
                <div class="col-xl-4 col-sm-6 mb-3">
                    <div class="widget-two b-radius-5 bg-warning">
                        <div class="widget-two__content">
                            <h2 class="text-white">USD {{ $depositals->where('status',2)->sum('amount') }}</h2>
                ...
                <div class="col-xl-4 col-sm-6 mb-3">
                    <div class="widget-two b-radius-5 bg-danger">
                        <div class="widget-two__content">
                            <h2 class="text-white">USD {{ $depositals->where('status',3)->sum('amount') }}</h2>
