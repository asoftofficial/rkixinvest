                    ...
                    <div class="row">
                        <div class="col-md-4 p-1">
                            ...
                            <div class="profile-work">
                                ...
                                <input type="button" class="btn btn-secondary btn-block" name="btnAddMore"
                                       value="Edit Profile"
                        ...
                        <div class="col-md-8">
                            <div class="profile-head ml-4">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link text-blue" id="home-tab" data-toggle="tab" href="#home"
                                           role="tab" aria-controls="home" aria-selected="true"
                                           style="border-bottom: 2px solid #007bff">About</a>
                                    </li>
                                </ul>
                            </div>
