                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="gap">
                            ...
                            <div id="refdiv">
                                <input type="text" class="form-control bg-white round-10 border-0" name="refLevels"
                                       id="refLevels">
                                <button type="button"
                                        class="btn btn-blue round-10 border-0 text-white px-5 createLevels"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.referrals.post')}}" method="POST">
                                            ...
                                            <div class='col-md-12'>
                                                <div class='refbonus-div mb-3'>
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text"
                                                               class="form-control only-decimal bg-light round-10 border-0"
                                                               placeholder="Referral Bonus" value="{{$ref->bonus}}"
                                                               name='bonuses[]'>
                            ...
                            <button class="btn btn-primary btn-blue saveReferrals px-5 mt-3" style="display: none">
                                Save
                            </button>
                        </form>
                    </div>
