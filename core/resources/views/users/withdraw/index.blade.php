...
@section('header-right')
    <a href="{{ route('user.withdraw.methods') }}"
       class="btn btn-primary btn-blue header-right-btn">@lang('Withdraw')</a>
@endsection
@push('script')
    ...
    <div class="container-fluid">
        ...
        <section class="collections">
            <div class="table-responsive">
                            ...
                            <td data-label="@lang('Status')">
                                ...
                                @elseif($data->status == 1)
                                    ...
                                    <button class="btn-info btn-rounded  badge approveBtn"
                                            data-admin_feedback="{{$data->admin_feedback}}"><i class="fa fa-info"></i>
                                    </button>
                ...
                {!! $withdraws->render('admin.custom-paginator') !!}
            </div>
        </section>
    </div>
    <!-- /.container-fluid -->
