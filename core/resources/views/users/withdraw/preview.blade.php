                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="withdraw-details">
                                    ...
                                    <span class="font-weight-bold pull-right">{{showAmount($withdraw->amount)  }} USD</span>
                                </div>
                                <div class="withdraw-details text-danger">
                                    <span class="font-weight-bold">@lang('Withdrawal Charge') :</span>
                                    <span class="font-weight-bold pull-right">{{showAmount($withdraw->charge) }} USD</span>
                                </div>
                                ...
                                <div class="form-group mt-5">
                                    ...
                                    <div class="input-group">
                                        <input type="text" value="{{showAmount($withdraw->user->balance - ($withdraw->amount))}}"  class="form--control bg-light border-0 p-1" placeholder="@lang('Enter Amount')" required readonly>
