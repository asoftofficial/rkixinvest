...
@section('header-right')
    <a href="{{ route('user.withdraw.history') }}"
       class="btn btn-primary btn-blue header-right-btn">@lang('Withdraw History')</a>
@endsection
@push('style')
    <style>
        .fileinput .thumbnail {
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="withdraw-details">
                                    ...
                                    <span
                                        class="font-weight-bold pull-right">{{showAmount($withdraw->amount)  }} USD</span>
                                </div>
                                <div class="withdraw-details text-danger">
                                    <span class="font-weight-bold">@lang('Withdrawal Charge') :</span>
                                    <span
                                        class="font-weight-bold pull-right">{{showAmount($withdraw->charge) }} USD</span>
                                </div>
                                <div class="withdraw-details text-info">
                                    <span class="font-weight-bold text--base">@lang('After Charge') :</span>
                                    <span class="font-weight-bold pull-right text--base">{{showAmount($withdraw->after_charge) }} USD</span>
                                </div>
                                <div class="withdraw-details">
                                    <span class="font-weight-bold">@lang('Conversion Rate') : <br>1 USD = </span>
                                    <span
                                        class="font-weight-bold pull-right">  {{showAmount($withdraw->rate)  }} {{__($withdraw->currency)}}</span>
                                </div>
                                <div class="withdraw-details text-success">
                                    <span class="font-weight-bold text--base">@lang('You Will Get') :</span>
                                    <span
                                        class="font-weight-bold pull-right text--base">{{showAmount($withdraw->final_amount) }} {{__($withdraw->currency)}}</span>
                                </div>
                                <div class="form-group mt-5">
                                    ...
                                    <div class="input-group">
                                        <input type="text"
                                               ...
                                               class="form--control bg-light border-0 p-1"
                            ...
                            <div class="col-md-8">
                                <form action="{{route('user.withdraw.submit')}}" method="post"
                                    ...
                                    @if($withdraw->method->user_data)
                                        @foreach(\GuzzleHttp\json_decode($withdraw->method->user_data) as $k => $v)
                                            @if($v->type == "text")
                                                ...
                                                <div class="form-group">
                                                    <div class="fileinput fileinput-new " data-provides="fileinput">
                                                        ...
                                                        <span class="btn btn-info btn-file">
                                                            <span
                                                                class="fileinput-new "> @lang('Select') {{__($v->field_level)}}</span>
                                    ...
                                    <div class="form-group">
                                        <button type="submit"
                                                class="btn btn-base w-100 btn-block btn-lg text-white btn-blue mt-4 text-center">@lang('Confirm')</button>
                                    </div>
                                </form>
                            </div>
                        </div>
