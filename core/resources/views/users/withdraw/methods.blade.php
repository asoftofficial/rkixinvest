                    ...
                    <div class="custom--card">
                        ...
                        <div class="card-footer">
                            <a href="javascript:void(0)" data-id="{{$data->id}}"
                               ...
                               class="btn btn-block text-white btn-blue w-100 withdraw" data-toggle="modal"
    ...
    <div class="modal fade" id="withdrawModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-610" role="document">
            <div class="modal-content issue-padd">
                ...
                <form action="{{route('user.withdraw.money')}}"
                    ...
                    <div class="modal-body  pt-0">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input id="amount" type="text" class="form-control bg-light border-0 round-10"
                                       name="amount" placeholder="@lang('Amount')" required value="{{old('amount')}}"
