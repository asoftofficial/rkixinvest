    ...
    <div class="modal-dialog modal-610" role="document">
        <div class="modal-content issue-padd">
            ...
            <div class="modal-body  pt-0">
                <form action="{{route('user.update.profile',$user->id)}}" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="gap">
                                        ...
                                        <div class="">
                                            <input type="text" class="form-control bg-light round-10 border-0" name="lname" value="{{$user->last_name}}"></div>
                                        @error('lname')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
